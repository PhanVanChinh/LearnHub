...
const toLesson = (l: LessonOut): Lesson => ({ title: l.title, duration: l.duration, free: l.free || undefined, video: l.video ?? undefined, hasVideo: l.has_video, quizCount: l.quiz_count || undefined, attachments: l.attachments?.length ? l.attachments : undefined });
